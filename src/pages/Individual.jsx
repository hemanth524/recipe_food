...
const Individual = () => {
  ...
  async function fetchData(ingredient) {
    let url = `${baseUrl}/filter.php?i=${ingredient}`;
    try {
  ...
  return (
    <div className='min-h-screen md:mt-10 mt-64 mb-10 p-4'>
      <div className='flex flex-col md:flex-row justify-center items-center mt-16 md:mt-32 gap-4'>
        <label className='w-full md:w-auto'>
          <input 
            ...
            placeholder='Enter the main Ingredient name'
          />
        </label>
        <button 
      ...
      <div className='flex flex-wrap justify-center mt-10 gap-4'>
        {meals.length === 0 ? (
          <div className='flex justify-center text-white  mt-10 text-3xl items-center h-64'>
           <img
           className='w-64 h-64'
            src={oops}></img>
          </div>
